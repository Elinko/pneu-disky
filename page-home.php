		...
		<div class="fh5co-hero">
			<div class="fh5co-cover text-center">
				<div class="desc animate-box">
					<h2>Lacné disky <br>a pneumatiky</h2>
					<span>Výber najpredávanejších a najlacnejších <br> pneumatík a diskov na internete</span>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12 text-center heading-section animate-box">
						<h3>Najpredávanejšie pneumatiky a disky</h3>
				...
				<ul class="nav nav-tabs" role="tablist">
					...
					<li role="presentation"><a href="#man" class="btn-primary" aria-controls="man" role="tab" data-toggle="tab">Top disky</a></li>
				</ul>
			</div>
			<div class="container">
				<div class="tab-content ">
					...
					<?php
						$args = array(
								'post_type' => 'produkty',
								'post_status' => 'publish',
								'cat' => 1537, // Whatever the category ID is for your aerial category
								'posts_per_page' => 12,
					...
					<?php
						$args = array(
								'post_type' => 'produkty',
								'post_status' => 'publish',
								'cat' => 1572, // Whatever the category ID is for your aerial category
								'posts_per_page' => 12,
								'orderby' => 'ID', // Purely optional - just for some ordering
								'order' => 'ASC' // Ditto
						);
											...
											<div class="blog-text" onclick="location.href='https://<?= the_field('url', $woman->posts[$i]->ID);  ?>'">
												<div class="prod-title">
														<div class="price-wrap">
															...
															<span class="price">od <?= the_field('cena', $woman->posts[$i]->ID);  ?> € </span>
														</div>
														...
														<a href="https://<?= the_field('url', $woman->posts[$i]->ID);  ?>" class="btn btn-primary">Viac detailov</a>
													</div>
											</div>
									</div>
								</div>
											...
											<div class="blog-text" onclick="location.href='https://<?= the_field('url', $man->posts[$i]->ID);  ?>'">
												<div class="prod-title">
														<div class="price-wrap">
															...
															<span class="price">od <?= the_field('cena', $man->posts[$i]->ID);  ?> € </span>
														</div>
														...
														<a href="https://<?= the_field('url', $man->posts[$i]->ID);  ?>" class="btn btn-primary">Viac detailov</a>
													</div>
											</div>
									</div>
								</div>
									...
									<div class="fh5co-blog animate-box">
											<div class="blog-text" onclick="location.href='https://<?= the_field('url');  ?>'">
												<div class="prod-title">
														...
														<h3><?= the_title();  ?></h3>
														<a href="https://<?= the_field('url');  ?>" class="btn btn-primary">Viac detailov</a>
													</div>
											</div>
									</div>
								</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						...
						<p>V našom blogu o pneumatikách Vám prinášame novinky zo sveta, zaujímavé štatistiky, ale aj akciové hity.</p>
					</div>
				</div>
			</div>
			<div class="container">
